...
func objectCreate(class interface{}, object interface{}, authOptions ...AuthOption) (interface{}, error) {
	...
	resp, err := c.request(methodPost, path, options, authOptions...)
	if err != nil {
		return nil, err
	}
...
func objectGet(ref interface{}, object interface{}, authOptions ...AuthOption) error {
	...
	resp, err := c.request(methodGet, path, c.getRequestOptions(), authOptions...)
	if err != nil {
		return err
	}
...
func objectDestroy(ref interface{}, authOptions ...AuthOption) error {
	...
	resp, err := c.request(methodDelete, path, c.getRequestOptions(), authOptions...)
	if err != nil {
		return err
	}
